...
class Drone(metaclass=SingletonMeta):
    ...
    def __init__(self) -> None:
        ...
        self.master = mavutil.mavlink_connection(
           "udp:192.168.1.30:14560",source_system=1, source_component=mavutil.mavlink.MAV_TYPE_ONBOARD_CONTROLLER, autoreconnect=True, force_connected=True,)  # in Arducopter cmd type: output add 192.168.1.18:14560
